...
export const getAllRoomsHandler = asyncHandler(async (req: Request, res: Response) => {
...
export const getRoomByIdHandler = asyncHandler(async (req: Request, res: Response) => {
